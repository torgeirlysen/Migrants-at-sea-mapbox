var config = {
    ...
    chapters: [
        ...
        },
        {
            ...
            <p>
            <b> Survivors reported that a Greek Coast Guard vessel approached and attached a rope to their boat, and that it capsized while being towed at speed. They said the Coast Guard attempted to pull them back toward Turkish waters (a pushback), but conditions aboard the fragile and overcrowded boat made it impossible to withstand the manoeuvre.  Greek authorities after first denying it, then acknowledged towing the boat but claimed it was intended to bring it toward Farmakonisi to effect a rescue; they denied that this was a forced return (pushback).  </b>
            </p>
        ...
        },
        {
            ...
            alignment: 'left',
            hidden: false,
            title: 'European Court of Human Rights RulinLag ',
            image: '',
            description: `
